...
\title{Linear Modeling, MSc Cognitive Systems}
...
<<samplingdistrnmeans,fig.width=6>>=
nsim<-1000
n<-100
mu<-500
sigma<-100
...
I have heard people say that there is no need to check for normality of residuals; indeed, Gelman and Hill state that it is the least important assumption in linear models. \textbf{However, this is a highly misleading statement and should be disregarded when the goal is null hypothesis testing}.  
